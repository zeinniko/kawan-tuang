...
@section('content')
  ...
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
    ...
    <div class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm divide-y divide-slate-100 dark:divide-slate-800 transition-colors overflow-hidden">
      ...
      <!-- 1. Edit Data Profile (Halaman Terpisah) -->
      ...
      <!-- 2. Riwayat Transaksi & Tracking (Halaman Order) -->
      ...
      <!-- 3. Alamat Pengiriman (User Address CRUD) -->
      ...
      <!-- 4. Toko Kami (Detail Map Toko) -->
      <a href="{{ route('home') }}#our-store" class="flex items-center justify-between p-4 sm:p-5 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
        <div class="flex items-center gap-3.5">
          <div class="w-10 h-10 rounded-xl bg-amber-500/10 text-amber-500 flex items-center justify-center shrink-0">
